...
//				conn = ConnectionClass.dbconnect();
				...
				try {
					...
					if(rs.next()) {
						...
						JOptionPane.showMessageDialog(frame, "You don't have account. Sign in first!");
					}
					pst.close();
					rs.close();
		...
		lblNewLabel_3.setBounds(60, 440, 270, 27);
		frame.getContentPane().add(lblNewLabel_3);
		
		JButton btnSignIn = new JButton("Sign in");
		btnSignIn.setFont(new Font("Lucida Sans", Font.PLAIN, 18));
		btnSignIn.setBounds(340, 440, 141, 27);
